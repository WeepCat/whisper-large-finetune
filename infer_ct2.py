...
# add_arg("model_path",  type=str,  default="/root/autodl-tmp/whisper-tiny-finetune-ct2", help="转换后的模型路径，转换方式看文档")
add_arg("model_path",  type=str,  default="/root/autodl-tmp/whisper-tiny", help="转换后的模型路径，转换方式看文档")
